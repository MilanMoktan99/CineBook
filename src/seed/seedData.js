...
// Theatre IDs
const THEATRE_IDS = [
  "12efb5be-808f-446c-b92d-23c025eefb0f",
  "b3b9dfa4-8ab5-4b75-bab5-8d05d7938d45",
  "033557c7-ae5a-4ab0-afd0-6b2357e2017d",
  "ccd11ceb-1803-4b30-bb3c-f13c4b9f121e",
  "b7500d18-d6d8-4772-816c-14ff8d14e698",
  "21e6875d-ca9c-4e2b-b122-4fe628be9ec4",
  "ae748353-1d22-44fd-8319-c42e5bfbb8e0",
  "49ea8d65-56db-4380-b2d8-ed506c87a942",
  "bbfaec79-2752-4c46-8014-c31773752465",
  "7c54c3ae-d46c-47ef-92dc-baa1c7892cfb",
];

// Theatres
const THEATRES = [
  { id: THEATRE_IDS[0], name: "IMAX Arena", location: "Kathmandu" },
  { id: THEATRE_IDS[1], name: "QFX Civil Mall", location: "Sundhara" },
  { id: THEATRE_IDS[2], name: "Big Movies", location: "City Center" },
  { id: THEATRE_IDS[3], name: "FCube Cinemas", location: "KL Tower" },
  { id: THEATRE_IDS[4], name: "Apple Cinemas", location: "New Road" },
  { id: THEATRE_IDS[5], name: "One Cinemas", location: "Eyeplex Mall" },
  { id: THEATRE_IDS[6], name: "BSR Movies", location: "Bhaktapur" },
  { id: THEATRE_IDS[7], name: "CG Cinemas", location: "CG Mall" },
  { id: THEATRE_IDS[8], name: "INI Cinemas", location: "Lalitpur" },
  { id: THEATRE_IDS[9], name: "FCube Premium", location: "Durbar Marg" },
];
...
export async function seedFirestore() {
    // checking if the movie already has the data
    const movieRef = collection(db, "movies");
    const existingMovies = await getDocs(movieRef);

    // checkif we already have that movies in our database collection called movies
    if(existingMovies.size > 0) {
        console.log("Movies already exits");
        return;
    }
    ...
    console.log("Seeding movie process complete.");

    // Seed/writing the theatre
    for(const theatre of THEATRES) {
        await setDoc(doc(db, "theatres", theatre.id), theatre);
    }

    console.log("Seeding threatre process complete");
    ...
    console.log("Seeding showtime complete");
